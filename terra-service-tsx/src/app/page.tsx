        ...
        <div className="w-full h-screen hero-bg">
          ...
          <div className="w-[80%] mx-auto glass">
            <div className="mt-[20%] p-2">
              <h1 className="text-4xl font-bold pb-4">Land registry as a service</h1>
              <p className="text-xl">Securing property rights through blockchain technology — transparent, immutable, and accessible.</p>
            </div>
